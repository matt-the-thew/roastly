      ...
      <div className="w-full flex justify-center" id={styles["wrapper"]}>
        <div className="w-[70%] max-w-200 py-30">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>CCPA</strong> and/or <strong>CPRA </strong>refers
                to the California Consumer Privacy Act (the
            ...
            <li>
              <p>
                ...
                Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                &quot;Our&quot; in this Privacy Policy) refers to Roastly.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>
              ...
              being sent. However, if You do not accept Cookies, You may
          ...
          <p>
            ...
            maximum periods (&quot;up to&quot;) and We may delete or
            anonymize data sooner when it is no longer needed for the
          ...
          <p>
            ...
            described above, and may be retained longer only where
          ...
          <ul>
            ...
            <li>
              ...
              This anonymized data may be retained indefinitely for
          ...
          <p>
            ...
            to, correct, or delete any Personal Data that You have provided
            to Us.
          </p>
          <p>
          ...
          <p>
            ...
            use commercially reasonable means to protect Your Personal
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                Examples: Browsing history, search history, information on
            ...
            <li>
              ...
              <p>
                Examples: Approximate physical location, physical location
                or movements.
              </p>
              <p>Collected: No.</p>
            </li>
            ...
            <li>
              ...
              <p>
                Examples: Government-issued identifying numbers, financial
                account details, genetic data, precise geolocation, race or
          ...
          <ul>
            ...
            <li>
              <strong>From Service Providers</strong>. For example, or
              other third-party vendors that We use to provide the Service
              to You.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              including to investigate and address Your concerns and
            ...
            <li>
              ...
              or as otherwise set forth in the CCPA/CPRA.
            </li>
            ...
            <li>
              Other purposes consistent with the context in which the
              information was collected, or as otherwise disclosed to You
          ...
          <p>
            ...
            &quot;sale&quot; mean selling, renting, releasing, disclosing,
            disseminating, making available, transferring, or otherwise
            communicating orally, in writing, or by electronic or other
            means, a Consumer's personal information by the Business to a
            third party for valuable consideration. This means that We may
            have received some kind of benefit in return for sharing
            personal information, but not necessarily a monetary benefit.
          </p>
          <p>
            We do not &quot;sell&quot; or &quot;share&quot; information as
            most people would commonly understand these terms – meaning We
            do not, and will not, disclose Your Personal Information in
            direct exchange for money or some other form of payment.
          </p>
          <p>
            We may disclose or may have disclosed in the last twelve (12)
            months the following categories in a manner that may be
            considered a &quot;sale&quot; or &quot;sharing&quot; as defined
            in CCPA/CPRA:
          </p>
          <ul>
            <li>
          ...
          <p>
            We retain California residents' Personal Information for as
            long as reasonably necessary to achieve the purposes described
            in this Privacy Policy (including the purposes disclosed in
            this CCPA/CPRA notice), taking into account: (i) how long we
            need the information to provide and maintain the Service and
            Your Account; (ii) whether You have requested deletion (subject
            to applicable exceptions); (iii) Our legal, tax, accounting,
            and regulatory obligations; (iv) security, fraud prevention,
            and abuse monitoring needs; and (v) the time periods needed to
            resolve disputes and enforce Our agreements.
          </p>
          <p>
            Specific retention periods for major data categories are
            described in the &quot;Retention of Your Personal
            Information&quot; section of Our Privacy Policy, and We may
            retain certain information longer where required or permitted
            by law (for example, to comply with recordkeeping obligations
          ...
          <p>
            ...
            affirmative authorization (the &quot;right to opt-in&quot;)
            from the parent or guardian of a Consumer less than 16 years of
            age. Consumers who opt-in to the sale of personal information
            may opt-out of future sales at any time. To exercise the right
            to opt-out, You (or Your authorized representative) may submit
            a request to Us by contacting Us.
          </p>
          <p>
            If You have reason to believe that a child under the age of 16
          ...
          <ul>
            <li>
              ...
              be notified which categories of Personal Information are
              being collected and the purposes for which the Personal
              Information is being used.
            </li>
            <li>
              <strong>The right to know/access.</strong> Under CCPA/CPRA,
              You have the right to request that We disclose information to
              You about Our collection, use, sale, disclosure for business
            ...
            <li>
              <strong>The right to correct Personal Information.</strong>{" "}
              You have the right to correct or rectify any inaccurate
              personal information about You that We collected. Once We
              receive and confirm Your request, We will use commercially
              reasonable efforts to correct (and direct our Service
              Providers to correct) Your personal information, unless an
              exception applies.
            </li>
            <li>
              <strong>
              ...
              You have the right to request to limit the use or disclosure
              of certain sensitive personal information We collected about
              You, unless an exception applies. To submit, please see the
              &quot;Limit the Use or Disclosure of My Sensitive Personal
              Information&quot; section or contact Us.
            </li>
            <li>
              <strong>The right to delete Personal Information.</strong>{" "}
              You have the right to request the deletion of Your Personal
              Information under certain circumstances, subject to certain
          ...
          <p>
            Please see the &quot;Do Not Sell or Share My Personal
            Information&quot; section and &quot;Limit the Use or Disclosure
            of My Sensitive Personal Information&quot; section for more
            information on how to opt out and limit the use of sensitive
            information collected.
          </p>
          <p>
            Additionally, in order to exercise any of Your rights under the
            CCPA/CPRA, and if You are a California resident, You can
            contact Us:
          </p>
          <ul>
            <li>
              ...
              <a
                ...
                data-cfemail="deb3bfaaaa9eacb1bfadaab2a7f0babba8"
              >
                [email&#160;protected]
              </a>
            </li>
          ...
          <p>
            ...
            once by an additional 45 days when reasonably necessary and
            with prior notice.
          </p>
          <p>
          ...
          <p>
            ...
            personal information. Once We receive and confirm a verifiable
            consumer request from You, We will stop &quot;selling&quot;
            Your Personal Information. To exercise Your right to opt-out,
            please contact Us or follow the below instructions.
          </p>
          <h3>
            Limit the Use or Disclosure of My Sensitive Personal
            Information
          ...
          <p>
            ...
            the use and disclosure of Your sensitive personal information
            to that use which is necessary to perform the services or
            provide the goods reasonably expected by an average consumer
            who requests such services or goods.
          </p>
          <p>
            ...
            the &quot;Use of Your Personal Information&quot; section or
            contact us.
          </p>
          <p>
            To submit a request to limit the use or disclosure of sensitive
            personal information, please contact Us using the methods
            listed in the &quot;Contact Us&quot; section of Our Privacy
            Policy.
          </p>
          ...
          <p>
            ...
            collected Personal Data from anyone under the age of 16 without
          ...
          <ul>
            <li>
              ...
              <a
                href="/cdn-cgi/l/email-protection"
                className="__cf_email__"
                data-cfemail="0a676b7e7e4a78656b797e6673246e6f7c"
              >
                matt@roastly.dev
              </a>
            </li>
