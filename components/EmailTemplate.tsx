...
export function EmailTemplate({ confirmUrl, email, actionType }: EmailTemplateProps) {
  ...
  return (
    <html lang="en">
      ...
      <body style={{ margin: 0, padding: 0, backgroundColor: "#f9fafb", fontFamily: "Helvetica Neue, Helvetica, Arial, sans-serif" }}>
              ...
              <td align="center">
                ...
                >
                  <tbody>
                    {/* Header */}
                    <tr>
                      <td style={{ backgroundColor: "#1c1917", padding: "28px 40px", textAlign: "center", borderRadius: "8px 8px 0 0" }}>
                        <span style={{ color: "#fbbf24", fontSize: "24px", fontWeight: "700", letterSpacing: "0.05em" }}>
                          Roastly
                        </span>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style={{ padding: "40px 40px 32px" }}>
                        <h1 style={{ margin: "0 0 16px", fontSize: "22px", fontWeight: "700", color: "#111827", lineHeight: "1.3" }}>
                          {heading}
                        </h1>
                        <p style={{ margin: "0 0 8px", fontSize: "14px", color: "#6b7280" }}>
                          For: {email}
                        </p>
                        <p style={{ margin: "0 0 32px", fontSize: "16px", color: "#374151", lineHeight: "1.6" }}>
                          {bodyText}
                        </p>
                        ...
                        <table cellPadding="0" cellSpacing="0" style={{ margin: "0 0 32px" }}>
                          <tbody>
                            <tr>
                              <td style={{ backgroundColor: "#b45309", borderRadius: "6px" }}>
                                <a
                                  href={confirmUrl}
                                  style={{
                        ...
                        <p style={{ margin: "4px 0 0", fontSize: "13px", lineHeight: "1.5" }}>
                          <a href={confirmUrl} style={{ color: "#b45309", wordBreak: "break-all" }}>
                            {confirmUrl}
                          </a>
                        </p>
                      </td>
                    ...
                    {/* Footer */}
                    <tr>
                      <td style={{ borderTop: "1px solid #e5e7eb", padding: "24px 40px", textAlign: "center", borderRadius: "0 0 8px 8px" }}>
                        <p style={{ margin: 0, fontSize: "12px", color: "#9ca3af" }}>
                          You received this email because an account action was requested for {email}.
